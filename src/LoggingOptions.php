...
final readonly class LoggingOptions
{
    ...
    public function __construct(
        ...
        public string $requestMessage = 'saloon-request',
        public string $responseMessage = 'saloon-response',
        public string $failureMessage = 'saloon-failure',
    ...
    public static function fromArray(array $config): self
    {
        ...
        return new self(
            ...
            requestMessage: self::string($messages['request'] ?? null, $d->requestMessage),
            responseMessage: self::string($messages['response'] ?? null, $d->responseMessage),
            failureMessage: self::string($messages['failure'] ?? null, $d->failureMessage),
    ...
    /**
     * Messages may contain placeholders: {connector}, {request}, {method}, {url}, {status}
     * and any scalar top-level context key, e.g. "checkout-to-{supplier}".
     */
    public function withMessages(?string $request = null, ?string $response = null, ?string $failure = null): self
    {
        return $this->with(
            requestMessage: $request ?? $this->requestMessage,
            responseMessage: $response ?? $this->responseMessage,
            failureMessage: $failure ?? $this->failureMessage,
        );
    }
